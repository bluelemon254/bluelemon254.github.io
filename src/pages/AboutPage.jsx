  ...
  return (
    <div className="container single-column-page">
      <section className="content-card">
        ...
        <h3>블로그를 쓰게 된 동기</h3>
        <p>
          학습하는 내용들을 항상 머리에 담아두기는 쉽지 않다. 대학교 2학년 전까지는 모든 것을 익혀서 
          장기기억에 넣으려고 했지만, 현실적으로 대학교 3학년이 되면서 그렇게 하는 것은 현실적으로 
          불가능하다는 것을 깨달았다. 따라서 이 블로그를 만들게 되었다. 종이 노트가 아니라 
          디지털 매체를 택한 이유는, 언제 어디서나 접근 가능하다는 장점 때문이다. 
        </p>
        <h3>글의 방향성</h3>
        <p>
